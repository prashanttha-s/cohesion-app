    ...
    <Layout>
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-3xl mx-auto">
          <h1 className="text-4xl font-bold mb-6">About Cohesion</h1>
          
          <div className="prose prose-lg max-w-none">
            <p className="text-muted-foreground text-lg mb-6">
              Cohesion is a platform dedicated to connecting passionate volunteers with meaningful opportunities to make a difference in their communities.
            </p>
            ...
            <p className="mb-6">
              Cohesion streamlines the volunteer experience by:
            </p>
            ...
            <p className="mb-6">
              Cohesion was founded in 2022 by a team of passionate individuals who saw a need for a more efficient way to connect volunteers with meaningful opportunities.
            </p>
