      ...
      <section className="py-16 bg-secondary/50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-2xl md:text-3xl font-bold mb-4">How Cohesion Works</h2>
      ...
      <section className="py-16 bg-secondary/50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Hear from volunteers who have made an impact through Cohesion.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-background border border-border rounded-lg p-6">
              ...
              <p className="text-muted-foreground mb-4">
                "Cohesion made it easy for me to find beach cleanup projects in my area. 
            ...
            <div className="bg-background border border-border rounded-lg p-6">
              ...
              <p className="text-muted-foreground mb-4">
                "As a retired teacher, I wanted to continue making an impact. Through Cohesion, 
